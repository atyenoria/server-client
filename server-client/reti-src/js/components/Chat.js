...
const Chat = React.createClass({
  ...
  componentDidMount() {
    ...
    if (window.innerWidth >4000) ChatActions.toggleVisibility();
  },
  ...
  _onChatStoreChange() {
    ...
    console.log("_onChatStoreChange()");
  },
  _onChangeMessage(e) {
    this.setState({message: e.target.value});
    console.log("_onChangeMessage(e)");
  },
